...
export default async function MonitoringPage() {
  ...
  const [{ data: tpsRows, error: tpsError }, { data: statuses, error: statusError }] = await Promise.all([
  ...
  return <MonitoringClient tpsRows={tpsRows ?? []} initialStatuses={statuses ?? []} serverNow={new Date().toISOString()} />;
}
